...
## 协作准则（用户要求·2026-08-15 起强制）

**执行任务时与 HD 协作**——不是"我做完再告诉它"，而是：
- **分工**：一人负责一个部分（如方案 B：我 Hermes 侧 + HD 侧）
- **并行**：我推进的同时派 HD 做它的部分（headless 或浏览器 3080）
- **双视角**：重要结论/诊断让 HD 独立复核（互相纠错）
- **接力**：我卡住/HD 卡住时对方接手（如 HD headless 嵌套卡→我接手）
- **实时汇报**：协作进度向用户实时汇报

适用：开发、研究、诊断、代码审查、方案设计。简单问答/单命令操作除外。
